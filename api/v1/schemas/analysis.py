...
# Import report types from history schema for type-safe report field
...
class AnalysisResultResponse(BaseModel):
    ...
    report: Optional[Union[AnalysisReport, dict, str]] = Field(
        None, description="分析报告（结构化 AnalysisReport 或原始 dict/str）"
    )
